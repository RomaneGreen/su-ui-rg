...
const requiredFields = {
    product: ['field-first-name', 'field-last-name', 'field-product-type', 'field-owner-yet', 'field-work-phone', 'field-mobile-phone', 'field-email',],
    location: ['field-address', 'field-city', 'field-state', 'field-zip', 'field-asset-type', 'field-property-type'],
    ...
    details: ['field-asking-price', 'field-listed', 'field-taxes-current'],
    generalInformation: ['field-closing-date', 'field-reason-selling', 'field-heard-about-us',]
}

export const validatePreferenceData = (activeStep, formData) => {
