            ...
            <div className="userImgUpload">
                <form onSubmit={(e)=>this._handleSubmit(e)}>
                    ...
                    <div className="internalCont">
                        ...
                        <div className="limit">PDF, JPEG or PNG / 2MB Max</div>
                    </div>
                    {/* <button className="submitButton" 
                    type="submit" 
                    onClick={(e)=>this._handleSubmit(e)}>Upload Image</button> */}
...
class Upload extends React.Component {
    ...
    render() {
        ...
        const { classes, formData, isMyAccount,
            buyerInfoEdit, paymentInfoEdit, onClick } = this.props;
        ...
        return (
            <div className={[classes.panelMain, classes.upload].join(' ')}>
                {isMyAccount &&
                <React.Fragment>
                ...
                <Grid className={[classes.panelWrapperBox + (isMyAccount ? ' myAccountPanelWrapper' : ''), classes.pdfUploaderWrapper].join(' ')}>
...
export default withStyles(onBoardingStyle, customInputStyle)(Upload);