...
class Preferences extends React.Component {
    ...
    render() {
        ...
        return (
                <div className={[classes.panelMain, classes.preferencesWrapper].join(' ')}>
                    ...
                    <Grid className={[classes.panelWrapperBox, classes.preferencesTeretories].join(' ')}>
                                ...
                                <div className={classes.fullWidth}>
                                    <Grid container spacing={32} className={"space-reset " + classes.cutomInputGridWrapper}>
                                            ...
                                            <FormControl variant="outlined" fullWidth className={'custom-form-control non-required'}>
                                                ...
                                                <Select value={getInputValue("first-preference-state")} onChange={handleInput} onBlur={handleChange}
                                                    ...
                                                    {staticData.states.map(state => (
                                                        <Fragment>
                                                            {(state.code === "NY" || state.code === "NJ" || state.code === "FL") && (
                                        ...
                                        <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                            ...
                                            <FormControl variant="outlined" fullWidth className={'custom-form-control non-required'}>
                                                <InputLabel htmlFor="first-preference-country">County</InputLabel>
                                        ...
                                        <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                            <div className={classes.staticLabels}></div>
                                            <FormControl variant="outlined" fullWidth className={'custom-form-control non-required'}>
                                                <InputLabel htmlFor="second-preference-country">County</InputLabel>
                                        ...
                                        <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                            <div className={classes.staticLabels}></div>
                                            <FormControl variant="outlined" fullWidth className={'custom-form-control non-required'}>
                                                <InputLabel htmlFor="third-preference-country">County</InputLabel>
                    ...
                    <div className={[classes.adgentPanelTagBar, classes.experienceOverTitle].join(' ')}>
...
export default withStyles(onBoardingStyle, customInputStyle)(Preferences);