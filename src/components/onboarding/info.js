...
class Info extends React.Component {
    ...
    render() {
        const { expanded, showLicenseInfo } = this.state;
        const { classes, isAgentOnboarding, handleChange, formData, invalidBuyerFormFields, handleInput, handlButtonToggle, validBuyerFormFields, isMyAccount,
                            ...
                            <Grid container
                                ...
                                <Grid item xs={isMyAccount ? 9 : 12} sm={6} lg={6}>
                                    <Typography className="form__heading" noWrap>
                                        {isAgentOnboarding ? 'AGENT' : 'TEAM MEMBER'} INFORMATION
                                    </Typography>
                                </Grid>
                                {isMyAccount ?
                                ...
                                <Grid container spacing={32} className={"space-reset " + classes.cutomInputGridWrapper}>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-first-name") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-first-name" name="field-first-name" value={formData["field-first-name"]} onChange={handleInput} onBlur={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-last-name") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-last-name" name="field-last-name" value={formData["field-last-name"]} onChange={handleInput} onBlur={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Hidden mdDown>
                                    ...
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-home-phone") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-home-phone" name="field-home-phone" value={formData["field-home-phone"]}
                                    ...
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-mobile-phone") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-mobile-phone" name="field-mobile-phone" value={formData["field-mobile-phone"]} onChange={handleInput} onBlur={handleChange}
                                    ...
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-home-email") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-home-email" name="field-home-email" value={formData["field-home-email"]} onChange={handleInput} onBlur={handleChange}
                                            />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        ...
                                        <div className={'smallGrid'}>
                                            <div className="col-as-3">
                                                <FormControl required variant="outlined" fullWidth className={getInputClasses("birth-month") + ' requiredInput smallInput'} >
                                                    ...
                                                    <OutlinedInput labelWidth={0} id="birth-month" name="birth-month" value={formData["birth-month"]} onChange={handleInput} onBlur={handleChange} />
                                                </FormControl>
                                            </div>
                                            <div className="col-as-3">
                                                <FormControl required variant="outlined" fullWidth className={getInputClasses("birth-date") + ' requiredInput smallInput'}>
                                                    ...
                                                    <OutlinedInput labelWidth={0} id="birth-date" name="birth-date" value={formData["birth-date"]} onChange={handleInput} onBlur={handleChange} />
                                                </FormControl>
                                            </div>
                                            <div className="col-as-3">
                                                <FormControl required variant="outlined" fullWidth className={getInputClasses("birth-year") + ' requiredInput smallInput'}>
                                                    ...
                                                    <OutlinedInput labelWidth={0} id="birth-year" name="birth-year" value={formData["birth-year"]} onChange={handleInput} onBlur={handleChange} />
                                                </FormControl>
                                            </div>
                                        </div>
                                    </Grid>
                                ...
                                <Grid container spacing={32} className={"space-reset " + classes.cutomInputGridWrapper}>
                                    <Grid item xs={12} sm={6} lg={8} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-address") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput autoComplete='nope' labelWidth={0} id="field-address" name="field-address" value={formData["field-address"]} onChange={handleInput} onBlur={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl variant="outlined" fullWidth className={'custom-form-control'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="address-suit" name="address-suit" value={formData["address-suit"]} onChange={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-city") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput labelWidth={0} id="field-city" name="field-city" value={formData["field-city"]} onChange={handleInput} onBlur={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-state") + ' requiredInput'}>
                                            <InputLabel htmlFor="state">State</InputLabel>
                                            <Select id="field-state" name="field-state" value={formData["field-state"]} onChange={handleInput} onBlur={handleChange}
                                    ...
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-zip") + ' requiredInput'}>
                                            ...
                                            <OutlinedInput autoComplete='nope' labelWidth={0} id="field-zip" name="field-zip" value={formData["field-zip"]} onChange={handleInput} onBlur={handleChange} />
                                        </FormControl>
                                    </Grid>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <div className="col-as-12">
                                        ...
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("field-country") + ' requiredInput'}>
                                            ...
                                            <Select value={formData["field-country"]} onChange={handleInput} onBlur={handleChange}
                                ...
                                <Grid container spacing={32} className={"space-reset " + classes.cutomInputGridWrapper}>
                                    <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                        <FormControl required variant="outlined" fullWidth className={getInputClasses("real-estate-license") + ' requiredInput'}>
                                            ...
                                            <Select id="real-estate-license" name="real-estate-license" value={formData["real-estate-license"]} onChange={handleInput} onBlur={handleChange}
                                                input={<OutlinedInput labelWidth={0} name="state" id="state" />}>
                                    ...
                                    {formData["real-estate-license"] === "1" &&
                                        <Fragment>
                                            <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                            ...
                                            <Grid item xs={12} sm={6} lg={4} className={classes.cutomInputGrid}>
                                                <FormControl required variant="outlined" fullWidth className={getInputClasses("field-license-state") + ' requiredInput'}>
                                                    ...
                                                    <Select id="field-license-state" name="field-license-state" value={formData["field-license-state"]} onChange={handleInput} onBlur={handleChange}
                                                        input={<OutlinedInput labelWidth={0} name="state" id="state" />}>
                                                        {staticData.states && staticData.states.map(state => (
                                                            <MenuItem key={state.code} value={state.code}>
                                                                {state.code} - {state.name}
...
export default withStyles(buyerStyle, customInputStyle)(Info);