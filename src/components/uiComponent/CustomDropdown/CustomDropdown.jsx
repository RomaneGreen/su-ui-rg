      ...
      <div className={classes.root}>
        ...
        >
          {({ TransitionProps, placement }) => (
            ...
            >
              <Paper className={`${classes.dropdown} hook-dropdown`}>
                <ClickAwayListener onClickAway={this.handleCloseAway}>
                  <React.Fragment>
                    <span className={`${classes.arrow} 'hook-customdropdown-arrow'`}></span>
                    <MenuList role="menu" className={`${classes.menuList} hook-menu-list`}>
