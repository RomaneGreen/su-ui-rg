...
class BloggerLogin extends React.Component {
    render() {
            ...
            <div className={classes.boxPanel}>
                <div className={classes.card}>
                    <div className={classes.cardHeaeder} >
                        <Typography variant="h3">Blogger Login</Typography>
                    </div> 
                    <div className={classes.cardImg}><i className="sb-icon-blogger"></i></div>
...
BloggerLogin.propTypes = {
    classes: PropTypes.object.isRequired,
};
export default withStyles(adminLoginStyle, customInputStyle)(BloggerLogin);