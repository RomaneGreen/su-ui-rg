            ...
            <div className={classes.boxPanel}>
                <div className={classes.card}>
                    <div className={classes.cardHeaeder} >
                        <Typography variant="h3">Sales Login</Typography>
                    </div> 
                    <div className={classes.cardImg}><i className="sb-icon-sales"></i></div>
...
export default withStyles(adminLoginStyle, customInputStyle)(SalesLogin);